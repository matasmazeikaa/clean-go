...
const Header = () => {
  ...
  return (
    <header className="header">
              ...
              <div>
                <div
                  className={classNames({
                    ...
                    "header__nav-paslauga-item--active":
                      serviceNavigationOpen === 0,
                  })}
              ...
              <div>
                {SERVICES_NAVIGATION[serviceNavigationOpen].items.map(item => (
                  <NavLink
                    to={item.to}
                    key={item.label}
                    className="header__nav-paslauga-item"
                  >
                    {item.label}
                  </NavLink>
                ))}
      ...
      <Button
        secondary
        onClick={scrollToSkaiciuokle}
        className="header__cta-btn"
        ariaLabel="skaičiuoklė"
      >
        Skaičiuoklė
      </Button>
