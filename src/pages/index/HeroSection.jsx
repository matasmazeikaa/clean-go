		...
		<div className="hero-section">
			...
			<Container>
				...
				<Section defaultPadding={false} className="hero-section__container">
					<div>
						...
						{!title && (
							<>
								...
								<h1 className="hero-section__title hero-section__title--mb h1">Jūs relaksuojat</h1>
								<p className="hero-section__body body-1">
									Mes esame patikima patalpų valymo įmonė, savo klientams siūlanti profesionalias ir
									kokybiškas butų, namų, komercinių patalpų bei langų valymo paslaugas.
								</p>
							</>
						)}
						{children}
					...
					<img src={HeroImg} alt="" className="hero-section__hero-img" />
				</Section>
			</Container>
		</div>
	</div>
