	...
	const updateOpenAnswer = useCallback(
		(value) => () => {
			QUESTIONS.forEach((question, index) => {
				if (index !== value) {
					const answerElement = window.document.getElementById(`answer-${index}`);
		...
		<Container>
			<Section className="questions-section">
				<div className="default-section-header-mb">
					<h2 className="h2 default-section-title-mb">Vis dar nesate užtikrinti?</h2>
					<p className="body-1">Keletas ataskymų į JŪSŲ dažniausiai užduodamus klausimus</p>
				</div>
				<div>
					{QUESTIONS.map((question, index) => (
						<div className="question-container">
							...
							<div id={`answer-${index}`} className="question-container__answer">
