...
const GeneralinisValymasPage = () => (
  <main>
    <Seo
      title="Generalinis patalpų valymas - patalpų valymo paslaugos"
      description="Mes teikiame aukščiausios kokybės generalinio patalpų valymo paslaugas. Patikrinkite, kaip mes galime atgaivinti jūsų patalpas."
    />
    <SubpageHeroSection
